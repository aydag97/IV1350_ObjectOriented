...
public class ViewTest {
    ...
    void simulateFakeSaleStoryTest(){
        ...
        assertAll(
            ...
            () -> assertTrue(outputString.contains("Something went wrong with scanning the item."), "Server connection message failed"),
            () -> assertTrue(outputString.contains("Something went wrong with scanning the item."), "Invalid item ID message failed"),
